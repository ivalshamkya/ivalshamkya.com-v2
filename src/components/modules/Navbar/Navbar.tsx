...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="w-full py-3 px-8 md:py-8 md:px-8 border-b border-dashed border-neutral-300 dark:border-neutral-800 flex justify-between items-center z-50">
